...
const (
	Auction_Bidding_FullMethodName   = "/Auction.Auction/Bidding"
...
func (c *auctionClient) GetResult(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
	err := c.cc.Invoke(ctx, Auction_GetResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuctionServer) GetResult(context.Context, *Empty) (*Result, error) {
